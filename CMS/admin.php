...
return [
    ...
    */
    ...
    'navbar-elements' => [
        ...
        'restrict' => 'Ограничьте роли, которые смогут видеть этот элемент',
	...
	'redirects' => [
        ...
        'title-edit' => 'Редактирование перенаправления :redirect',
        'title-create' => 'Создание перенаправления',
        ...
        'status' => [
            'created' => 'Перенаправление было создано.',
            'updated' => 'Перенаправление было обновлено.',
            'deleted' => 'Перенаправление было удалено.',
        ],
    ],
    ...
    'update' => [
		...
		'changelog' => 'Журнал изменений доступен <a href=":url" target="_blank" rel="noopener noreferrer">здесь</a>.',
        'download' => 'Последняя версия Азуриом готова к загрузке.',
        'install' => 'Последняя версия Azuriom загружена и готова к установке.',

        'backup-info' => 'Перед обновлением  Azuriom, необходимо сделать резервную копию своего сайта!',
